...
export default function EducationAdmin() {
  ...
  const currentEducations = filteredEducation.slice(indexOfFirstEdu, indexOfLastEdu);
        ...
        <div className="experiencestable">
          ...
          {filteredEducation.length > 0 && (
            <div className="experiencepagination">
              ...
              <button onClick={() => paginate(currentPage + 1)} disabled={currentEducations.length < perPage}>
                Next
              </button>
            </div>
          )}
