...
export default function draftshop() {
  ...
  const publishedexperiences = currentExperiences.filter(
    (ab) => ab.status === "draft"
  );
  const pageNumber = [];
      ...
      <LoginLayout>
        <div className="experiencepage">
          <div className="titledashboard flex flex-sb">
            ...
            <div>
              <FaShoppingCart />
              <span> /</span> <span>AddProduects</span>
            </div>
          </div>
                          ...
                          <tr key={experience._id}>
                            ...
                            <td>
                              <div className="flex gap-2 flex-center">
                                <Link href={"/shops/edit/" + experience._id}>
                                  <button>
                                    <FaEdit />
                                  </button>
                                </Link>
                                <Link href={"/shops/delete/" + experience._id}>
                                  <button>
                                    <MdDeleteSweep />
                                  </button>
                                </Link>
