...
export default function Project(
    ...
    async function createExperience(ev) {
        ...
        const data = { title, slug, images, description, livepreview, projectcategory, tags, status, client };
    ...
    return <>
        <form className='addWebsiteform' onSubmit={createExperience}>
            ...
            <div className="w-100 flex flex-col flex-left mb-2">
                ...
                <input type="text" id="livepreview" placeholder='Enter Livepreview URL'
                    value={livepreview}
